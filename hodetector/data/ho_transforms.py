...
from detectron2.structures import Boxes, BoxMode, Instances, PolygonMasks, polygons_to_bitmask, Keypoints, BitMasks
...
def annotations_to_instances(annos, image_size, mask_format="polygon", file_name = "None"):
    """
    ...
    target.gt_masks = PolygonMasks([obj["segmentation"] for obj in annos])

    interaction = [torch.tensor(obj["interaction"]) for obj in annos]
    ...
    def __call__(self, dataset_dict):
        ...
        if "annotations" in dataset_dict:
            ...
            instances = annotations_to_instances(
                annos, image_shape, mask_format=self.instance_mask_format, file_name = dataset_dict["file_name"]
            )
